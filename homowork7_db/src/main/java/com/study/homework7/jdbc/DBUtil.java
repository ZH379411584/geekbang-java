...
public class DBUtil {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/order1?rewriteBatchedStatements=true&useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&useSSL=false&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai";
    // 数据库的用户名和密码
